...
.menu-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-top: 2rem; }
.menu-btn { background: linear-gradient(135deg, #7B2CBF, #00F5D4) !important; color: #0A041A !important; border-radius: 20px !important; font-weight: 800 !important; padding: 1.5rem !important; height: auto !important; width: 100% !important; border: none !important; }
</style>
...
def init_db():
    ...
    c.executemany("INSERT INTO milestones VALUES (?,?)", [
        ("First Liked Story ✨", "2025-07-27"), ("Official Anniversary 🎉", "2025-08-22"), 
        ("NZ Trip 🏔️", "2026-03-29"), ("Army 🪖", "2026-04-20"), ("1st Anniv 2026 🎉", "2026-08-22")
    ])
...
if st.session_state.view == "login":
    ...
    st.markdown("""<div class='hero-card'>🌷🌻💐<br><br><b>For My Favorite Rival 😈</b><br><br>Thanks for sticking around, even when I'm moody! 555. Let's keep supporting each other for a long, long time. 💜</div>""", unsafe_allow_html=True)
    ...
    # (Insert Timeline/Stats logic here)
