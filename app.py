...
# ======== TAB 0: GET FLOWERS & 3 INTERACTIVE MENUS ========
with tab_flower:
    st.markdown("""
    <div style="text-align: center; padding: 1.5rem 0;">
        ...
        <p style="color: #4CC9F0; font-size: 1rem; font-weight: 600; letter-spacing: 1px;">Well done! A bouquet for my favorite enemy. 😜</p>
    </div>
    """, unsafe_allow_html=True)
